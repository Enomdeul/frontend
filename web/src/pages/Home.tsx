...
export function Home() {
  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col overflow-hidden">
      {/* 배경 이미지 */}
      <div className="absolute h-[570px] left-0 top-0 w-full bg-cover bg-center bg-no-repeat z-0" style={{backgroundImage: `url(${homeBackground})`}} />
      {/* 메인 콘텐츠 */}
      <div className="flex flex-col w-full relative z-10">
        {/* 헤더 - + AS 버튼과 링크 아이콘 */}
        <div className="relative z-20 flex h-[54px] items-center justify-between px-4">
          <div className="h-[16px] w-[45.636px]">
            <img alt="AS Logo" src={SmallLogo} className="block w-full h-full" />
          </div>
          <button className="w-6 h-6 flex items-center justify-center" onClick={() => navigate("/card/offered-list")}>
        ...
        <div className="flex flex-col items-center pt-4">
          <h1 className={`${textStyles.h3} text-[20px] text-[#2A2A35] leading-[1.5] text-center`}>My 카드</h1>
          ...
          <div className="flex flex-col gap-6 w-full max-w-[358px] mx-auto">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col items-start gap-1">
                <img alt="" src="https://www.figma.com/api/mcp/asset/0aa2bf1c-d934-472c-b99f-4ae8b61659be" className="w-[10.893px] h-[10.698px]" />
                <h3 className={`${textStyles.h3} text-[20px] text-[#2A2A35]`}>Add your Skills!</h3>
              </div>

              {/* 스킬 칩들 */}
              <div className="flex gap-3 flex-wrap">
                <SkillChip label="Adobe Premier" selected={selectedSkill1 === "Adobe Premier"} onClick={() => setSelectedSkill1(selectedSkill1 === "Adobe Premier" ? null : "Adobe Premier")} />
                <SkillChip label="JAVA" selected={selectedSkill1 === "JAVA"} onClick={() => setSelectedSkill1(selectedSkill1 === "JAVA" ? null : "JAVA")} />
                <SkillChip label="Slack" selected={selectedSkill1 === "Slack"} onClick={() => setSelectedSkill1(selectedSkill1 === "Slack" ? null : "Slack")} />
              </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col items-start gap-1">
                <img alt="" src="https://www.figma.com/api/mcp/asset/0aa2bf1c-d934-472c-b99f-4ae8b61659be" className="w-[10.893px] h-[10.698px]" />
                <h3 className={`${textStyles.h3} text-[20px] text-[#2A2A35]`}>Add more Skills!</h3>
              </div>

              {/* 스킬 칩들 */}
              <div className="flex gap-3 flex-wrap">
                <SkillChip label="Jira" selected={selectedSkill2 === "Jira"} onClick={() => setSelectedSkill2(selectedSkill2 === "Jira" ? null : "Jira")} />
                <SkillChip label="Slack" selected={selectedSkill2 === "Slack"} onClick={() => setSelectedSkill2(selectedSkill2 === "Slack" ? null : "Slack")} />
                <SkillChip label="Microsoft Word" selected={selectedSkill2 === "Microsoft Word"} onClick={() => setSelectedSkill2(selectedSkill2 === "Microsoft Word" ? null : "Microsoft Word")} />
              </div>
