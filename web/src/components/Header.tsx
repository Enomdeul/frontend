...
export default function Header({title, onClick}: HeaderProps) {
  return (
    <div className="bg-white flex items-stretch w-full h-[54px]">
      {/* Left Icon Button */}
      ...
      <div className="flex-1 flex items-center justify-center">
        <span className={`${textStyles.subtitle.semibold} text-[18px] leading-[1.5em] text-center text-[#2A2A35]`}>{title}</span>
      </div>
